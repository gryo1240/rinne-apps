...
/* ============ §5 称号 ============ */
// 2026-07-19 オーナー指示で上位3段階を追加（1600止まりでは上級者の伸びしろがないため）。
// 最上位2800点の根拠: ノーミス想定でKPM100≒2600点・KPM120≒3250点（スコア式からの機械概算）。
var TITLES = [
  { min: 2800, name: "フリック異次元" },
  { min: 2400, name: "人類最速の親指" },
  { min: 2000, name: "フリック大明神" },
