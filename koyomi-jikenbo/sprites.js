...
var SPRITES = {
  ...
  // 表情ID → { char, label, img? }
  faces: {
    koyomi_normal:  { char: "koyomi", label: "" },
    koyomi_smile:   { char: "koyomi", label: "" },
    koyomi_serious: { char: "koyomi", label: "" },
    koyomi_think:   { char: "koyomi", label: "" },
    koyomi_sad:     { char: "koyomi", label: "" },
    hinata_worried: { char: "hinata", label: "" },
    hinata_cry:     { char: "hinata", label: "" },
    hinata_surprise:{ char: "hinata", label: "" },
    hinata_talk:    { char: "hinata", label: "" },
    hinata_smile:   { char: "hinata", label: "" },
